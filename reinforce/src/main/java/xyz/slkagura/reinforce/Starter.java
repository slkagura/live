...
public class Starter extends Application {
    ...
    private static final String CURRENT_ACTIVITY_THREAD_NAME = "currentActivityThread";
    
    private static final String INSTRUMENTATION_FIELD_NAME = "mInstrumentation";
    
    private final String mDelegateApplicationName = "xyz.slkagura.ui.LiveApplication";
    ...
    public String getPackageName() {
        if (TextUtils.isEmpty(mDelegateApplicationName)) {
    ...
    private void attachApp() {
        ...
        Class<?> delegateClass;
        try {
            delegateClass = Class.forName(mDelegateApplicationName);
            ...
            mApplicationInfo.className = mDelegateApplicationName;
            // 再次调用 onCreate 方法
    ...
    public void attachActivity() {
        ...
        try {
            // PrivateApi
            activityThreadClass = Class.forName(ACTIVITY_THREAD_CLASS_NAME);
            // DiscouragedPrivateApi
            Method currentActivityThreadMethod = activityThreadClass.getDeclaredMethod(CURRENT_ACTIVITY_THREAD_NAME);
            currentActivityThreadMethod.setAccessible(true);
            Object currentActivityThread = currentActivityThreadMethod.invoke(null);
            // 拿到在ActivityThread类里面的原始mInstrumentation对象
            // DiscouragedPrivateApi
            Field mInstrumentationField = activityThreadClass.getDeclaredField(INSTRUMENTATION_FIELD_NAME);
